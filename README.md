...
├── docs/SMOKE_TEST.md      # the by-hand release checklist
...
Every release is walked through by hand as well as by the suite — the full
checklist (language, currency, cart, checkout, payments, admin, resilience)
lives in **[docs/SMOKE_TEST.md](docs/SMOKE_TEST.md)**.
